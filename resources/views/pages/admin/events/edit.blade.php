    ...
    <form action="{{ route('admin.events.update', $event->id) }}" method="POST" enctype="multipart/form-data" id="event-form" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="lokasi" value="{{ old('lokasi', $event->lokasi) }}" required class="input input-bordered w-full px-4 py-2 border rounded-lg focus:ring-blue-500 focus:border-blue-500 text-sm">
            </div>
